...
Test it on parameters for my laboratory variant (aiming method wasn't provide
target catch).
...
cat('Input:\n')
print(.default.input)
model2 <- my.model(.default.input)
plot(model2$points[,1], model2$points[,2], type='l')
points(model2$target[1], model2$target[2], pch=4, col='red')
cat('Time is', model2$time)
```
