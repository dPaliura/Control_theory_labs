...
* Formulated [must conditions](#boat-speed) to solve problem with 
  aiming method.
...
* [Proposed algorithm](#algorithm-proposition) which provide problem solution if
  sufficient conditions satisfied.
* Proposed algorithm [coded and tested](#proposed-algorithm-test).
