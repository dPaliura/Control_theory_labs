...
the well-known models for modeling epidemics is SIRD (Susceptible, Infected,
Recovered, Dead). All parameters will be set randomly in recommended intervals
that are respective to the COVID-19 pandemic. Also, the SIRD model can be
complicated with some special values.\
